    ...
    api.interceptors.response.use(function (response) { return response; }, function (error) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            ...
            if (((_e = error.response) === null || _e === void 0 ? void 0 : _e.status) === 401) {
                return [2, Promise.reject(__assign(__assign({}, error), { message: message, redirectToLogin: true }))];
            }
            return [2, Promise.reject(__assign(__assign({}, error), { message: message }))];
        });
    }); });
    return api;
};
